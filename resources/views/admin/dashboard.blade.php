...
@section('sidebar')
    ...
    <a href="{{ route('admin.guests') }}" class="nav-link">
        ...
        <div class="col-md-3 mb-3">
            <div class="card card-stats text-white" style="background:#a67c52;">
                <div class="card-body">
                    ...
                    <small>This month: {{ $monthlyBookings }}</small>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="card card-stats text-white" style="background:#8b5e3c;">
                <div class="card-body">
                    ...
                    <small>This month: Rp {{ number_format($monthlyRevenue, 0, ',', '.') }}</small>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="card card-stats text-white" style="background:#c8a97e;">
                <div class="card-body">
                    ...
                    <small>{{ $occupiedRooms }} / {{ $totalRooms }} rooms occupied</small>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.restaurant-menus') }}" class="btn btn-sm btn-outline-primary">Manage</a>
                </div>
                <div class="card-body">
...
<script>
    ...
    new Chart(payCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: {!! json_encode($paymentDistribution) !!},
