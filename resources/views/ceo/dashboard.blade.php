...
@section('title', 'CEO Executive Dashboard')
@section('page-title', 'Executive Management Analytics')

@section('sidebar')
    <a href="{{ route('ceo.dashboard') }}" class="nav-link active">
...
<div class="container-fluid py-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">Data Analitik Terkonsolidasi per {{ now()->format('d M Y') }}</small>
        </div>
    ...
    {{-- ── STAT CARDS NOMINAL SESUAI REQUEST (TIDAK KOSONG) ──────────────── --}}
    <div class="row mb-4">
    ...
    {{-- ── CHART REVENUE TREND + BREAKDOWN LINGKARAN ── --}}
    <div class="row mb-4">
    ...
    {{-- ── CHART TOP MENU TRAFFIC + STRUKTUR BOOKING ─────────────────────── --}}
    <div class="row mb-4">
