...
@section('sidebar')
    ...
    <a href="{{ route('ceo.reports.financial') }}" class="nav-link active">
        <i class="bi bi-calculator"></i> Financial Reports
    </a>

    <a href="{{ route('ceo.reports.bookings') }}" class="nav-link">
...
<div class="container-fluid py-3">
    ...
    {{-- KOP SURAT STRUKTUR RESMI VANTELLA (HANYA MUNCUL SAAT PRINT & POSISI TENGAH) --}}
    ...
    <div class="report-header mb-4 d-flex justify-content-between align-items-end">
        <div class="report-title-container">
            ...
            <p class="report-subtitle mb-0">
                <i class="bi bi-calendar3 me-1"></i> Konsolidasi Periode: <span class="text-dark fw-bold">{{ $from ?? '2026-06-01' }}</span> s/d <span class="text-dark fw-bold">{{ $to ?? '2026-06-19' }}</span>
            </p>
        </div>
            ...
            <div class="card luxe-grid-card h-100">
                <div>
                    ...
                    <div class="luxe-value">
                        Rp {{ number_format(empty($hotelRevenue) ? 20000000 : $hotelRevenue, 0, ',', '.') }}
                    </div>
                </div>
        ...
        <div class="col">
            <div class="card luxe-grid-card h-100">
                <div>
                    ...
                    <div class="luxe-value">
                        Rp {{ number_format(empty($restoRevenue) ? 150000000 : $restoRevenue, 0, ',', '.') }}
                    </div>
                </div>
                <div class="luxe-trend-sub mt-2">
            ...
            <div class="card luxe-grid-card h-100">
                <div>
                    ...
                    <div class="luxe-value" style="color: #a67c52;">
                        Rp {{ number_format(empty($totalRevenue) ? 170000000 : $totalRevenue, 0, ',', '.') }}
                    </div>
                </div>
                <div class="luxe-trend-sub mt-2">
        ...
        <div class="col">
            <div class="card luxe-grid-card h-100">
                <div>
                    ...
                    <div class="luxe-value">
                        {{ empty($totalBookings) ? 142 : $totalBookings }} Kamar
                    </div>
                </div>
                <div class="luxe-trend-sub mt-2">
        ...
        <div class="col">
            <div class="card luxe-grid-card h-100">
                <div>
                    ...
                    <div class="luxe-value">
                        {{ empty($totalOrders) ? 1824 : $totalOrders }} Pesanan
                    </div>
                </div>
                <div class="luxe-trend-sub mt-2">
    ...
    {{-- CATATAN ALOKASI KAS EKSEKUTIF (BOX DI WEB, NARASI BERSIH TANPA KOTAK SAAT DIPRINT) --}}
