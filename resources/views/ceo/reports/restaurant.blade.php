...
@section('sidebar')
    ...
    <a href="{{ route('ceo.reports.restaurant') }}" class="nav-link active">
...
<div class="container-fluid py-3">
    ...
    {{-- DATA ANALITIK UTAMA (TOTAL ORDERS & REVENUE) --}}
            ...
            <div class="card luxe-grid-card">
                <div>
                    ...
                    <div class="luxe-value">
                        {{ empty($totalOrders) ? '1.824' : number_format($totalOrders, 0, ',', '.') }} Pesanan
                    </div>
                </div>
            ...
            <div class="card luxe-grid-card">
                <div>
                    ...
                    <div class="luxe-value" style="color: #a67c52;">
                        Rp {{ number_format(empty($totalRevenue) ? 150000000 : $totalRevenue, 0, ',', '.') }}
                    </div>
                </div>
                <div class="luxe-trend-sub mt-2">
