...
<nav>
  ...
  <div class="nav-auth">
    ...
    <a href="{{ route('customer.new-booking') }}" class="btn-booking-nav">✦ Booking</a>
  </div>
</nav>
...
<section class="hero">
  <div class="hero-content">
    ...
    <div class="hero-btns">
      <a href="{{ route('customer.new-booking') }}" class="btn-primary">✦ Booking Sekarang</a>
    ...
    <div class="rooms-grid">
      <div class="room-card">
        ...
        <div class="room-body">
          ...
          <a href="{{ route('customer.new-booking') }}" class="btn-book">Booking Sekarang</a>
        </div>
      </div>
      <div class="room-card">
        <div class="room-img">
      ...
      <div class="room-card">
        ...
        <div class="room-body">
          ...
          <a href="{{ route('customer.new-booking') }}" class="btn-book" style="background:linear-gradient(135deg,#b8860b,var(--gold-light));color:#2a1f1f">Booking Sekarang</a>
        </div>
      </div>
    </div>
  </div>
...
<section id="restoran" class="section resto-section">
  <div class="container">
    ...
    <div class="menu-grid">
      ...
      <div class="menu-card">
        <div class="menu-img"><img src="{{ url('images/Nasi GS.jpg') }}" alt="Nasi Goreng"></div>
        <div class="menu-info">
          ...
          <div class="menu-footer">
            ...
            <button class="btn-order" onclick="openOrderModal('Nasi Goreng Special Hotel','⭐ Signature Dish',45000,'{{ url('images/Nasi GS.jpg') }}','Nasi goreng premium dengan telur mata sapi, ayam suwir, dan sambal spesial khas hotel.')">Pesan Sekarang</button>
          </div>
        </div>
      </div>

      <div class="menu-card">
        <div class="menu-img"><img src="{{ url('images/steak.jpg') }}" alt="Steak"></div>
        <div class="menu-info">
          ...
          <div class="menu-footer">
            ...
            <button class="btn-order" onclick="openOrderModal('Steak Tenderloin','Premium Beef',120000,'{{ url('images/steak.jpg') }}','Daging sapi pilihan, dimasak sempurna dengan saus mushroom cream dan roasted veggies.')">Pesan Sekarang</button>
          </div>
        </div>
      </div>

      <div class="menu-card">
        <div class="menu-img"><img src="{{ url('images/Spaghetti.jpg') }}" alt="Spaghetti"></div>
        <div class="menu-info">
          ...
          <div class="menu-footer">
            ...
            <button class="btn-order" onclick="openOrderModal('Spaghetti Carbonara','Italian Cuisine',65000,'{{ url('images/Spaghetti.jpg') }}','Pasta creamy dengan keju parmesan asli, telur, dan bacon crispy premium.')">Pesan Sekarang</button>
          </div>
        </div>
      </div>

      <div class="menu-card">
        <div class="menu-img"><img src="{{ url('images/Teriyaki.jpg') }}" alt="Chicken Teriyaki"></div>
        <div class="menu-info">
          ...
          <div class="menu-footer">
            ...
            <button class="btn-order" onclick="openOrderModal('Chicken Teriyaki','Japanese Style',55000,'{{ url('images/Teriyaki.jpg') }}','Ayam panggang dengan glazing teriyaki homemade, disajikan dengan nasi dan salad segar.')">Pesan Sekarang</button>
          </div>
        </div>
      </div>

      <div class="menu-card">
        <div class="menu-img"><img src="{{ url('images/sushi.jpg') }}" alt="Sushi"></div>
        <div class="menu-info">
          ...
          <div class="menu-footer">
            ...
            <button class="btn-order" onclick="openOrderModal('Sushi Platter','Premium Sushi',150000,'{{ url('images/sushi.jpg') }}','20 pcs sushi premium: salmon, tuna, ebi, dan california roll dengan wasabi dan jahe segar.')">Pesan Sekarang</button>
          </div>
        </div>
      </div>

      <div class="menu-card">
        <div class="menu-img"><img src="{{ url('images/salmon.jpg') }}" alt="Salmon"></div>
        <div class="menu-info">
          ...
          <div class="menu-footer">
            ...
            <button class="btn-order" onclick="openOrderModal('Grilled Salmon Fillet','Chef\'s Special',95000,'{{ url('images/salmon.jpg') }}','Salmon atlantik segar dipanggang dengan lemon butter herb sauce dan mashed potato lembut.')">Pesan Sekarang</button>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h4>Layanan</h4>
        <ul class="footer-links-col">
          <li><a href="{{ route('customer.new-booking') }}">Booking Online</a></li>
