...
@section('sidebar')
    ...
    <a href="{{ route('resepsionis.bookings.create') }}" class="nav-link active">
...
<div class="booking-wrapper">
    ...
    <form method="POST" action="{{ route('resepsionis.bookings.store') }}" id="bookingForm">
        @csrf
        ...
        <div class="section-card">
            ...
            {{-- Grouped Room Selection (Tanpa Harga di Teks Nama Kamar) --}}
            <div class="mb-3">
        ...
        {{-- ── Section 3: Payment & Metode Pembayaran ── --}}
        <div class="section-card">
            <div class="section-header">
            ...
            {{-- MODUL METODE PEMBAYARAN INTERAKTIF --}}
            <div class="mb-0">
                ...
                {{-- Container Detail Instruksi Pembayaran (QRIS / Rekening) --}}
        ...
        <div class="action-bar">
            <a href="{{ route('resepsionis.bookings.index') }}" class="btn-cancel">Batal</a>
