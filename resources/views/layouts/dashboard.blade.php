...
<title>@yield('title', 'Dashboard') — VANTELLA Hotel</title>
...
{{-- SIDEBAR --}}
<div class="sidebar">
    <a href="{{ route('landing') }}" class="sidebar-brand">VANTELLA Hotel</a>
    <div class="sidebar-role">{{ auth()->user()->role->name ?? 'User' }}</div>
