...
@section('sidebar')
    ...
    <a href="{{ route('kasir.hotel.transactions.history') }}" class="nav-link active">
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            {{-- Nomor Kwitansi --}}
                            <td><span class="text-muted fw-medium">#{{ $p->id }}</span></td>
                            ...
                            {{-- Periode Stay (Gabungan Check In - Out) --}}
                            ...
                            {{-- Status Keberadaan Tamu (Check Out / In) --}}
                            <td>
                            ...
                            <td class="text-secondary font-monospace">
                                {{ is_string($p->created_at) ? $p->created_at : $p->created_at->format('d M Y H:i') }}
                            </td>
                        </tr>
                        @empty
                        <tr>
