...
@section('title', 'Input Pembayaran Hotel')
@section('page-title', 'Form Input Pembayaran')
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form id="paymentForm" method="POST" action="{{ route('kasir.hotel.payments.store') }}">
                    @csrf
...
function searchBooking() {
    ...
    $.get('{{ route("kasir.hotel.payments.search") }}', {q: keyword})
