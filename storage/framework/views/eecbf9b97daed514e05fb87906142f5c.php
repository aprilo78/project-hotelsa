...
<?php $__env->startSection('title', 'Riwayat Transaksi Restoran'); ?>


<?php $__env->startSection('sidebar'); ?>
    <a href="<?php echo e(route('kasir.restoran.dashboard')); ?>"
       class="nav-link <?php echo e(request()->routeIs('kasir.restoran.dashboard') ? 'active' : ''); ?>">
        <i class="bi bi-speedometer2"></i> Dashboard
    </a>

    <a href="<?php echo e(route('kasir.restoran.pos')); ?>"
       class="nav-link <?php echo e(request()->routeIs('kasir.restoran.pos') ? 'active' : ''); ?>">
        <i class="bi bi-cart"></i> POS
    </a>

    <a href="<?php echo e(route('kasir.restoran.orders.index')); ?>"
       class="nav-link <?php echo e(request()->routeIs('kasir.restoran.orders.*') ? 'active' : ''); ?>">
        <i class="bi bi-list-check"></i> Orders
    </a>

    <a href="<?php echo e(route('kasir.restoran.history')); ?>"
       class="nav-link <?php echo e(request()->routeIs('kasir.restoran.history') ? 'active' : ''); ?>">
        ...
        <div class="table-responsive">
            <table class="data-table" id="historyTable">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $simulatedPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="history-row-item" data-tanggal="<?php echo e($p['date']); ?>" data-nominal="<?php echo e($p['amount']); ?>">
                        <td class="ps-4 fw-bold" style="color: #a67c52;">#<?php echo e($p['id']); ?></td>
                        <td>
                            <span class="fw-bold text-dark"><?php echo e($p['customer_name']); ?></span>
                        </td>
                        <td>
                            <?php if($p['method'] == 'cash'): ?>
                                <span class="method-badge method-cash"><i class="bi bi-cash-stack"></i> Cash</span>
                            <?php elseif($p['method'] == 'qris'): ?>
                        ...
                        <td class="text-center text-muted" style="font-size: 13px;">
                            <div><?php echo e(date('d M Y', strtotime($p['date']))); ?></div>
                            <small style="font-size: 11px;"><i class="bi bi-clock"></i> Pukul <?php echo e($p['time']); ?> WIB</small>
                        </td>
                        <td class="text-center pe-4">
                            <button type="button" class="btn btn-sm btn-outline-gold" onclick="simulasiCetakStrukUlang(<?php echo e($p['id']); ?>, '<?php echo e($p['customer_name']); ?>', '<?php echo e($p['method']); ?>', <?php echo e($p['amount']); ?>, '<?php echo e($p['date']); ?> <?php echo e($p['time']); ?>')">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-hotel-saapp\resources\views/kasir/restoran/history.blade.php ENDPATH**/ ?>