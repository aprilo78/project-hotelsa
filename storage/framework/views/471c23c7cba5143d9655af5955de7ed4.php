...
<?php $__env->startSection('sidebar'); ?>
    ...
    <a href="<?php echo e(route('kasir.hotel.transactions.history')); ?>"
       class="nav-link <?php echo e(request()->routeIs('kasir.hotel.transactions.*') ? 'active' : ''); ?>">
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="text-muted font-monospace fw-medium">#INV-<?php echo e($p->id); ?></span></td>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('kasir.hotel.invoices.show', $p->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-hotel-saapp\resources\views/kasir/hotel/invoices.blade.php ENDPATH**/ ?>