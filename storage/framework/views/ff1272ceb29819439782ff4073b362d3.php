...
<?php $__env->startSection('title', 'Kasir Hotel Dashboard'); ?>
<?php $__env->startSection('page-title', 'Dashboard Kasir Hotel'); ?>

<?php $__env->startSection('sidebar'); ?>
    <a href="<?php echo e(route('kasir.hotel.dashboard')); ?>" class="nav-link active">
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold">Rp <?php echo e(number_format($todayTransactions, 0, ',', '.')); ?></h3>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold"><?php echo e($pendingPayments); ?> <span class="fs-6 fw-normal text-white-50">Transaksi</span></h3>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 fw-bold">Rp <?php echo e(number_format($monthlyTotal, 0, ',', '.')); ?></h3>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-3 text-secondary font-monospace">
                                    <?php echo e(is_string($transaction->created_at) ? $transaction->created_at : $transaction->created_at->format('d/m/Y H:i')); ?>

                                </td>
                                <td>
                                    <span class="badge bg-light text-dark border px-2 py-1" style="font-size: 12px; border-radius: 6px;">
                                        #<?php echo e($transaction->booking_id); ?>

                                    </span>
                                </td>
                                <td><strong><?php echo e($transaction->booking->guest->name ?? '-'); ?></strong></td>
                                <td><span class="fw-bold text-dark">Rp <?php echo e(number_format($transaction->amount, 0, ',', '.')); ?></span></td>
                                <td>
                                ...
                                <td class="pe-3">
                                    <span class="status-badge status-<?php echo e($transaction->payment_status); ?>">
                                        <i class="bi bi-circle-fill" style="font-size: 6px;"></i> <?php echo e($transaction->payment_status); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-hotel-saapp\resources\views/kasir/hotel/dashboard.blade.php ENDPATH**/ ?>