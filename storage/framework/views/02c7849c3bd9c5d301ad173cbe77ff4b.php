...
body{
  ...
  background:url("<?php echo e(asset('images/regis2.jpg')); ?>") center/cover no-repeat;
  ...
  <div class="card-body">
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>">
      ...
      <div class="form-group">
        ...
        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="<?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        <label>Email</label>
        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="<?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="password" name="password" required class="<?php echo e($errors->has('password') ? 'is-invalid' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\project-hotel-saapp\resources\views/auth/register.blade.php ENDPATH**/ ?>