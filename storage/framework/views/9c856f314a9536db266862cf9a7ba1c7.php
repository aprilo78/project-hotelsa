...
<?php $__env->startSection('sidebar'); ?>
    ...
    <a href="<?php echo e(route('resepsionis.rooms')); ?>" class="nav-link active">
    ...
    <div class="card-body px-4 pb-4">
        <div class="table-responsive">
            <table class="table align-middle" id="roomsTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $activeRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><span class="text-muted fw-medium"><?php echo e($loop->iteration); ?></span></td>
                        <td>
                        ...
                        <td>
                            <strong class="text-dark"><?php echo e($room->roomType->name ?? '-'); ?></strong>
                        </td>
                        <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-hotel-saapp\resources\views/resepsionis/rooms/index.blade.php ENDPATH**/ ?>