...
<div class="card-header d-flex justify-content-between align-items-center bg-transparent border-0 pt-4 px-4">
    ...
    <a href="<?php echo e(route('resepsionis.bookings.create')); ?>" class="btn btn-lux btn-sm">
...
<td><span class="text-muted fw-medium">#<?php echo e($booking->id); ?></span></td>

<td><strong><?php echo e($booking->guest->name ?? $booking->user->name ?? '-'); ?></strong></td>

<td><span class="badge bg-light text-dark border px-2 py-1" style="font-size: 12px;">Room <?php echo e($booking->room->room_number); ?></span></td>

<td><span class="text-secondary font-monospace" style="font-size: 12.5px;"><?php echo e($booking->check_in_date); ?></span></td>
<td><span class="text-secondary font-monospace" style="font-size: 12.5px;"><?php echo e($booking->check_out_date); ?></span></td>

<td><span class="fw-bold text-dark">Rp <?php echo e(number_format($booking->total_price, 0, ',', '.')); ?></span></td>
...
<div class="d-inline-flex gap-1">
    ...
    <button class="btn-action-icon"
        ...
        data-bs-target="#viewModal<?php echo e($booking->id); ?>" title="View Detail">
        <i class="bi bi-eye"></i>
    </button>

    
    <?php if($booking->booking_status == 'pending'): ?>
    <button class="btn-action-icon" onclick="confirmBooking(<?php echo e($booking->id); ?>)" title="Confirm Booking">
        <i class="bi bi-check2"></i>
    </button>
    <?php endif; ?>

    <?php if($booking->booking_status == 'confirmed'): ?>
    <button class="btn-action-icon" onclick="checkIn(<?php echo e($booking->id); ?>)" title="Check In">
        <i class="bi bi-box-arrow-in-right"></i>
    </button>
    <?php endif; ?>

    <?php if($booking->booking_status == 'checked_in'): ?>
    <button class="btn-action-icon" onclick="checkOut(<?php echo e($booking->id); ?>)" title="Check Out">
        <i class="bi bi-box-arrow-right"></i>
    </button>
    <?php endif; ?>

    
    <?php if(!in_array($booking->booking_status, ['checked_out','cancelled'])): ?>
    <button class="btn-action-icon btn-action-danger" onclick="cancelBooking(<?php echo e($booking->id); ?>)" title="Cancel Booking">
...
<?php $__currentLoopData = $activeBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="viewModal<?php echo e($booking->id); ?>" tabindex="-1" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content" style="border-radius:12px;">
<div class="modal-header border-0 pt-4 px-4">
    <h5 class="lux-title mb-0">Detail Booking #<?php echo e($booking->id); ?></h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body px-4 pb-4">
    <div class="p-3 bg-light rounded-3">
        <p class="mb-1 text-muted fs-7">Nama Tamu</p>
        <h6 class="fw-bold mb-3"><?php echo e($booking->guest->name ?? $booking->user->name ?? '-'); ?></h6>
        
        <div class="row">
            <div class="col-6">
                <p class="mb-1 text-muted fs-7">Nomor Kamar</p>
                <h6 class="fw-bold">Kamar <?php echo e($booking->room->room_number); ?></h6>
            </div>
            <div class="col-6">
                <p class="mb-1 text-muted fs-7">Total Bayar</p>
                <h6 class="fw-bold text-success">Rp <?php echo e(number_format($booking->total_price, 0, ',', '.')); ?></h6>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-hotel-saapp\resources\views/resepsionis/bookings/index.blade.php ENDPATH**/ ?>