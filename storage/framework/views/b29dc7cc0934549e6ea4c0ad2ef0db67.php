...
<?php $__env->startSection('title', 'Cari Kamar'); ?>
<?php $__env->startSection('page-title', 'Cari Kamar'); ?>
...
<?php $__env->startSection('sidebar'); ?>
    ...
    <a href="<?php echo e(route('customer.new-booking')); ?>" class="nav-link active">
...
<div class="search-header">
    <div class="d-flex justify-content-between flex-wrap gap-2 align-items-center">
        <div>
            ...
            <div class="mt-1">
                <small>
                    ...
                    ?>
                    (<?php echo e($searchNights); ?> malam)
                </small>
                <?php if(request('guests')): ?>
                <small class="ms-3">
                    <i class="bi bi-people me-1"></i><?php echo e(request('guests')); ?> tamu
                </small>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        ...
        <form action="<?php echo e(route('customer.search-rooms')); ?>" method="GET"
            ...
            <div>
                ...
                <input type="number" name="guests" class="form-control-sm"
                       value="<?php echo e(request('guests', 1)); ?>" min="1" max="10"
...
<?php else: ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <span class="text-muted" style="font-size:.85rem">
            <strong style="color:#1A1A2E"><?php echo e($rooms->count()); ?></strong> kamar ditemukan
        </span>
    </div>
                ...
                <div class="col-md-6 p-3 d-flex flex-column justify-content-between">
                    <div>
                        <h6 style="font-weight:700;color:#1A1A2E;margin-bottom:4px">
                            Kamar <?php echo e($room->room_number); ?>
                        ...
                        <p class="text-muted mb-2" style="font-size:.82rem">
                            <i class="bi bi-people me-1"></i>Kapasitas <?php echo e($room->capacity ?? 2); ?> orang
                            <?php if($room->floor ?? false): ?>
                                <span class="mx-1">·</span>
                                <i class="bi bi-layers me-1"></i>Lantai <?php echo e($room->floor); ?>
                        ...
                        <div class="mb-2">
                            ...
                            <?php if($room->has_breakfast ?? false): ?>
                            <span class="feature-tag"><i class="bi bi-cup-hot"></i> Sarapan</span>
                            <?php endif; ?>
                        </div>

                        <?php if($room->description ?? false): ?>
                ...
                <div class="col-md-3 p-3 d-flex flex-column justify-content-between align-items-end"
                    ...
                    <div class="text-end">
                        ...
                        <div style="font-weight:700;color:#1A1A2E;font-size:.95rem">
                            Rp <?php echo e(number_format($totalRoom, 0, ',', '.')); ?>

                        </div>
                        <?php endif; ?>
                    </div>

                    <a href="<?php echo e(route('customer.new-booking')); ?>?room_id=<?php echo e($room->id); ?>&check_in=<?php echo e(request('check_in')); ?>&check_out=<?php echo e(request('check_out')); ?>&guests=<?php echo e(request('guests', 1)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-hotel-saapp\resources\views/customer/search-rooms.blade.php ENDPATH**/ ?>