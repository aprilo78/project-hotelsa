<footer>
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo e(route('landing')); ?>#kamar">Kamar & Suite</a></li>
                    <li><a href="<?php echo e(route('landing')); ?>#restoran">Restoran</a></li>
                    <li><a href="<?php echo e(route('landing')); ?>#tentang">Tentang Kami</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            © <?php echo e(date('Y')); ?> DRG Hotel. Semua hak dilindungi undang-undang.
        </div>
    </div>
</footer>
